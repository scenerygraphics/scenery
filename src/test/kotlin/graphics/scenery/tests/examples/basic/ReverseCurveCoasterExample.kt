...
import graphics.scenery.flythroughs.ReverseRollercoaster
import graphics.scenery.geometry.CatmullRomSpline
import graphics.scenery.geometry.Curve
import graphics.scenery.numerics.Random
import org.joml.Vector3f

class ReverseCurveCoasterExample: SceneryBase("CurveRollerCoaster", wantREPL = true, windowWidth = 1280, windowHeight = 720) {
    ...
    override fun init() {
        ...
        val geo = Curve(catmullRom, false, true) { triangle(splineSize) }
        geo.name = "curve"
    ...
    override fun inputSetup() {
        super.inputSetup()
            inputHandler?.addBehaviour(
                "rollercoaster",
                ReverseRollercoaster(scene, { scene.activeObserver }, "curve")
            )
    ...
    companion object {
        ...
        fun main(args: Array<String>) {
            ReverseCurveCoasterExample().main()
        }
    }
}
