...
import graphics.scenery.primitives.ParticleGlyph
...
class ParticleGlyphExample : SceneryBase("ParticleGlyphExample") {
    override fun init() {
        ...
        val particleRadii = FloatBuffer.allocate(particleNumber)
        ...
        repeat(particleNumber) {
            ...
            particleRadii.put(Random.nextDouble(0.01, 0.05).toFloat())
        ...
        val particleGlyph = ParticleGlyph(particlePos, particleRadii, particleColor, false)
        particleGlyph.name = "Particles"
        scene.addChild(particleGlyph)
        ...
        thread {
            ...
            while (running) {
                ...
                particlePos.flip()
                particleGlyph.updatePositions(particlePos)
        ...
        thread {
            ...
            Thread.sleep(6000)
            renderer?.recordMovie("./ParticleGlyphExample.mp4")
            Thread.sleep(15000)
    ...
    override fun main() {
        ...
        assertions[AssertionCheckPoint.AfterClose]?.add {
            val f = File("./ParticleGlyphExample.mp4")
            try {
