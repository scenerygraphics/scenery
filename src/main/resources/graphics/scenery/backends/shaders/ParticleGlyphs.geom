...
layout(location = 4) out ParticleData /*This is the data for one particle*/ {
    flat vec3 Center;
...
void main() {
    ...
    SilhouetteCorner.Center = sc;
    SilhouetteCorner.Radius = sr;
    Particle.Center = VertexIn[0].Position;
    Particle.Properties = VertexIn[0].Properties;
    EmitVertex();
