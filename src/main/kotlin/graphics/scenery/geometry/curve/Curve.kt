...
class Curve (baseShape: () -> List<List<Vector3f>>, spline: Spline,
    ...
    private val partitionAlongControlpoints: Boolean = true): Mesh("CurveGeometry"), CurveInterface {
    ...
    init {
        ...
        if(partitionAlongControlpoints) {
            ...
            subShapes.forEachIndexed { index, list ->
                ...
                val trianglesAndNormals = CurveInterface.calculateTriangles(arrayList, addCoverOrTop = i)
