...
class InputHandler(scene: Scene, renderer: Renderer, override var hub: Hub?, forceHandler: Class<*>? = null) : Hubable, AutoCloseable {
     ...
     */
        ...
        behaviourMap.put("gamepad_movement_control", GamepadMovementControl("gamepad_movement_control", listOf(Component.Identifier.Axis.Z, Component.Identifier.Axis.X, Component.Identifier.Axis.Y), { scene.findObserver() }))
