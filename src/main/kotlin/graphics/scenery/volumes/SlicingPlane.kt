...
class SlicingPlane(override var name: String = "Slicing Plane") : Node() {
    // TODO this has to become List<Volume> once the custom shader uniforms are there
    var slicedVolumes = listOf<VolumeManager>()
    ...
    init {
        postUpdate.add{
            ...
            slicedVolumes.forEach { it.slicingPlane = planeEq}
        }
    }
