...
//    constructor():this(hub) //TODO: needs to be uncommented for proper serialization
    ...
    override fun constructWithParameters(parameters: Any, hub: Hub): Networkable {
        ...
        return when(fileSource.type){
            ...
            VolumeFileSource.VolumeType.SPIM -> Volume.fromSpimFile(path, hub, VolumeViewerOptions.options())
        }
    }
...
//            voxelSizes.dimension(2).toFloat() * pixelToWorldRatio
    ...
    companion object {
        ...
        fun forNetwork(params: VolumeFileSource,
            ...
            val vol = Volume(hub = hub).constructWithParameters(params,hub) as Volume
