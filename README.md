...
----
__Hello, this is the master branch, where development happens and stuff breaks.__ If you require a stable version of scenery, please check out the [latest stable version of this repository, version 0.5.0](https://github.com/scenerygraphics/scenery/tree/scenery-0.5.0).
----
...
```groovy
compile group: 'graphics.scenery', name: 'scenery', version: '0.5.1-SNAPSHOT'
compile group: 'net.clearvolume', name: 'cleargl', version: '2.2.0'
```
